...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-pic --enable-postproc --prefix=/usr/local --target-os=darwin --arch=x86_64 --cpu=generic --disable-doc --disable-debug --enable-asm --enable-videotoolbox --enable-hwaccel=h264_vda --enable-gpl --enable-nonfree --enable-libaacplus --enable-librtmp --enable-static --enable-pthreads --enable-zlib --enable-encoder=libx264 --enable-libx264 --enable-encoder=libopenh264 --enable-libopenh264 --enable-muxer=h264 --extra-cflags='-fpic -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2-mac/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include' --extra-ldflags='-L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib-mac -L/usr/local/lib' --extra-libs='-laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -ldl -lrtmp -lpthread -lstdc++ -lm'
prefix=/usr/local
...
CFLAGS=-fPIC  -fpic -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2-mac/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -I/usr/local/include -I/usr/local/Cellar/x264/r2555/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -D_THREAD_SAFE -I/usr/local/include/SDL2
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -fpic -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2-mac/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include -fPIC -Qunused-arguments
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib-mac -L/usr/local/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS=-laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -ldl -lrtmp -lpthread -lstdc++ -lm 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
...
EXTRALIBS-avformat=-lm -lbz2 -L/usr/local/lib -lz -Wl,-framework,CoreFoundation -Wl,-framework,Security
EXTRALIBS-avcodec=-liconv -lm -llzma -L/usr/local/lib -lz -framework AudioToolbox -L/usr/local/Cellar/x264/r2555/lib -lx264 -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
...
EXTRALIBS-cws2fws=-L/usr/local/lib -lz
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
!ARCH_ARM=yes
!ARCH_AVR32=yes
